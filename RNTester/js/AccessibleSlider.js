...
class AccessibleSlider extends PureComponent {
  static propTypes = {
      ...
      <View
        ...
        onAccessibilityAction={(event) => {
          ...
          switch(event.nativeEvent.actionName) {
            case 'increment':
              newValue = Math.min(this.props.maximumValue, currentValue + 0.1);
            break;
            case 'decrement':
              newValue = Math.max(this.props.minimumValue, currentValue - 0.1)
            break;
          }
...
module.exports = AccessibleSlider;
